...
<template>
    <div
        class="flex items-center justify-center h-screen text-center bg-gray-100"
    >
        <svg
        ...
        <div class="p-8 bg-white rounded-lg shadow-md">
            ...
            <Link
                href="/"
                class="inline-block px-6 py-2 transition duration-200 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90"
            >
                Go Back to Home
            </Link>
        </div>
